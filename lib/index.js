...
>>>>>>> 527855e93d6f6bd074f3bfcb32234d6afae677cb
  ...
  self.movies = new Movies(self);

  var groceries = require('./groceries');
<<<<<<< HEAD
  self.groceries = new groceries(self)i;
=======
  self.groceries = new groceries(self);

  var Pharmacy  = require('./pharmacy');
  self.pharmacy = new Pharmacy(self);
>>>>>>> 527855e93d6f6bd074f3bfcb32234d6afae677cb
...
<<<<<<< HEAD
    ...
    "movies": ["movies", "bollywood", "tollywood", "kollywood", "hollywood"],
    "groceries":["groceries","fruits","pulses","type","vegetables"],
=======
    "movies": ["movies", "bollywood", "tollywood", "kollywood", "hollywood"],

    "groceries":["groceries","fruits","pulses","type","vegetables"],
    "pharmacy" :["pharmacy", "surgical", "syrups", "tablets","vaccine",],
>>>>>>> 527855e93d6f6bd074f3bfcb32234d6afae677cb
